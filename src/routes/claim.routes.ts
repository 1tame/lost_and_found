...
import { createClaim, getClaimsForMyItems, updateClaimStatus, getMyClaimHistory } from "../controllers/claim.controller";
...
router.get('/my-claims', verifyToken, getClaimsForMyItems )
